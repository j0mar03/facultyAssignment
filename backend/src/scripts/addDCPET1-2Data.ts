...
// New DCPET 1-2 schedule data for First semester 2025-2026
...
export class DCPET1_2DataAdder {
  static async addData() {
    console.log('Starting DCPET 1-2 data addition...');
    ...
    try {
      ...
      console.log(`Adding DCPET 1-2 data for ${semester} semester, ${academicYear}...`);
      ...
      // Step 3: Create new sections for DCPET 1-2
      console.log('Creating new sections for DCPET 1-2...');
      ...
      console.log('DCPET 1-2 data addition completed successfully!');
      ...
      const totalSections = await sectionRepo.count({
        where: { sectionCode: 'DCPET 1-2', academicYear: academicYear }
      });

      console.log(`Summary:`);
      console.log(`- Total courses created/updated: ${uniqueCourses.size}`);
      console.log(`- Total DCPET 1-2 sections created: ${totalSections}`);
      console.log(`- Total courses in ${semester} semester ${academicYear}: ${totalCourses}`);

    } catch (error) {
      console.error('Error adding DCPET 1-2 data:', error);
      throw error;
    }
  }
}
